...
static const char def_conf[] = "kimominer.conf";
...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITHOUT_ARG("--submit-stale",
			opt_set_bool, &opt_submit_stale,
		        "submit shares if they are detected as stale - not recommended"),
	OPT_WITH_ARG("--pass|-p",
		     set_pass, NULL, NULL,
	...
	OPT_WITHOUT_ARG("--scrypt",
			...
			"Use the scrypt-kimo algorithm for mining scrypt (NO factor scrypt!)"),
	OPT_WITHOUT_ARG("--nscrypt",
			opt_set_bool, &opt_nscrypt,
			"Use the scrypt-kimo algorithm for mining (NO scrypt!)"),
	...
	OPT_WITH_ARG("--thread-concurrency",
		     ...
		     "Set GPU thread concurrency for scrypt-kimo mining, comma separated"),
#endif
	OPT_WITH_ARG("--url|-o",
		     set_url, NULL, NULL,
